...
BUTTON_COLOR = "#900C3F"
BUTTON_COLOR2 = "#C70039"
BUTTON_COLOR3 = "#CD5C5C"
...
# Create Lables to capture the Video frames
label = Label(win)
label.place(x=60, y=0)

label2 = Label(win)
label2.place(x=screen_width // 2 + 1 + 60, y=0)

label3 = Label(win)
label3.place(x=screen_width - 400 - 10, y=screen_height - 330 - 20)

# Create Labels to display feed titles
label4 = Label(win, text="SKULL AVATAR")
# Font size
label4.config(font=("Courier", 30))
# Background color
label4.config(bg=BUTTON_COLOR3)
# Border Width
label4.config(borderwidth=5)
label4.place(x=60, y=0)

label5 = Label(win, text="BODY MESH")
# Font size
label5.config(font=("Courier", 30))
# Background color
label5.config(bg=BUTTON_COLOR3)
# Border Width
label5.config(borderwidth=5)
label5.place(x=screen_width // 2 + 1 + 60, y=0)

label6 = Label(win, text="ORIGINAL")
# Font size
label6.config(font=("Courier", 30))
# Background color
label6.config(bg=BUTTON_COLOR3)
# Border Width
label6.config(borderwidth=5)
label6.place(x=screen_width - 400 - 10, y=screen_height - 330 - 20)

# Buttons on the Right side of the window

button = Button(win, text="CAP", command=click_handler)
# Font size
button.config(font=("Courier", 30))
# Background color
button.config(bg=BUTTON_COLOR2)
# Border Width
button.config(borderwidth=5)

button2 = Button(win, text="GLASSES", command=click_handler)
# Font size
button2.config(font=("Courier", 30))
# Background color
button2.config(bg=BUTTON_COLOR2)
# Boreder Width
button2.config(borderwidth=5)

# Place the button on the window
button.place(x=screen_width // 2, y=600)
button2.place(x=screen_width // 2 - 40, y=700)
